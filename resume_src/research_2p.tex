...
\cite{Sung:Fleisig:Hope:Upadhyay:Boyd-Graber-2025,
...
This work led to \emph{ALTO}, which cast topic modeling as an
active learning problem \cite{lund-17}, and \emph{BASS}, which integrated
