...
adversarial examples~\cite{wallace-09}.
...
Using language-based games such as \textit{Diplomacy} as testbeds, a
testbed we have been aruing for in the NLP context for over a
decade~\cite{niculae-15}.
%
My collaborators and I showed that agents optimized solely for
game-theoretic objectives (i.e., Meta's \textit{tour de force} Cicero)
fail to capture essential social and linguistic nuance
