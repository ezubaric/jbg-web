\begin{enumerate*}
        \item Kyle Seelman (UMD CMSC, 2022--2025): Interactive Neural
          Topic Models [Roblox]
       \item YooYeon Sung (iSchool, 2021--2025): Adversarial Examples for
         Question Answering and Disinformation [Hippocratic AI]
  ...
  \item Yoshinari Fujinuma (Colorado CMSC, 2016--2021): Multilingual
    Dense Representations [Amazon]        
      \item Denis Peskoff\footnote{Formerly Denis Peskov, but changed
          his name to distinguish himself from the son of Kremlin
          spokesperson} (UMD CMSC, 2017--2021): Human-in-the-loop
        Data Curation [Princeton University, Postdoc $\rightarrow$
        Berkeley University, Postdoc]
