...
implement it is the subject of my recently awared \textsc{nsf career}
grant.  By creating teams of humans and computers working together to
solve language problems incrementally, we can create metrics that
measure how much machine learning systems (and their visualizations)
