...
\begin{enumerate}
  ...
  Topic Control in Conversations using Speaker-centric Nonparametric Topic Models}.  \emph{Mid-Atlantic Student Colloquium on Speech, Language, and Learning}, 2012.
	 ...
	 \item Sonya S. Nikolova, {\bf Jordan Boyd-Graber}, and Perry Cook.  {\bf \href{http://cs.umd.edu/~jbg//docs/viva.pdf}{The Design of ViVA: A Mixed-initiative Visual Vocabulary for Aphasia}}.  \emph{Proceedings of the 27th international conference extended abstracts on Human factors in computing systems}, 2009, 6 pages.
