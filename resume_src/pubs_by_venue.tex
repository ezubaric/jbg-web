...
\begin{enumerate}
	 \item \underline{\href{https://ishani-mondal.github.io/}{Ishani Mondal}}, Yiwen Song, Mihir Parmar, Palash Goyal, {\bf Jordan Boyd-Graber}, Tomas Pfister, and Yale Song.  {\bf \href{http://cs.umd.edu/~jbg//docs/2026_emnlp_canvas.pdf}{CANVAS: Continuity-Aware Narrative Generation via Visual Agentic Storyboarding}}.  \emph{Findings of Empirical Methods in Natural Language Processing}, 2026 (29.7\% Acceptance Rate).

	 \item Senyi Zhang, \underline{Tasnim Kabir}, and {\bf Jordan Boyd-Graber}.  {\bf \href{http://cs.umd.edu/~jbg//docs/2026_emnlpfindings_diver.pdf}{Um, Actually: Timely and Calibrated Fact-Checking with DIVER}}.  \emph{Findings of Empirical Methods in Natural Language Processing}, 2026 (29.7\% Acceptance Rate).
...
\begin{enumerate}
	 ...
	 \item \underline{\href{https://nbalepur.github.io/}{Nishant Balepur}}, Paiheng Xu, Wei Ai, Eunsol Choi, Rachel Rudinger, and {\bf Jordan Boyd-Graber}.  {\bf \href{http://cs.umd.edu/~jbg//docs/2026_emnlp_scoreboard.pdf}{Check The Scoreboard: An Analysis of Scoring Schemes on Multiple-Choice Evaluation}}.  \emph{Empirical Methods in Natural Language Processing}, 2026 (15.4\% Acceptance Rate).

	 \item \underline{\href{https://nehasrikn.github.io/}{Neha Pundlik Srikanth}}, {\bf Jordan Boyd-Graber}, and Rachel Rudinger.  {\bf \href{http://cs.umd.edu/~jbg//docs/2026_emnlp_discotrace.pdf}{DiscoTrace: Representing and Comparing Answering Strategies of Humans and LLMs in Information-Seeking Question Answering}}.  \emph{Empirical Methods in Natural Language Processing}, 2026 (15.4\% Acceptance Rate).

	 \item \underline{\href{https://ishani-mondal.github.io/}{Ishani Mondal}}, Javad Baghirov, and {\bf Jordan Boyd-Graber}.  {\bf \href{http://cs.umd.edu/~jbg//docs/2026_emnlp_figure_video.pdf}{Helping Figures Tell their Story! Paper-Grounded Video Generation Explaining Complex Scientific Figures}}.  \emph{Empirical Methods in Natural Language Processing}, 2026 (15.4\% Acceptance Rate).
