...
make sure that students learn not just about how \abr{ai} works but
also know its limitations.
%
Like all teachers, I've been impressed by the breadth of
questions---both conceptual and coding---that \abr{ai} can now answer.
%
However, these systems are not without weaknesses, and a course still
needs an examination to measure what the students have learned.
%
Thus, in addition to in-class examinations (midterms), we also have
students write questions that they believe will challenge an \abr{ai}
but not their fellow classmates: in the \abr{ai} literature, these are
called adversarial questions.
%
We then score how adversarial the questions are \citep[e.g., use item
response theory to measure the gap between human and computer
difficulty]{Sung:Gor:Fleisig:Mondal:Boyd-Graber-2025}.
%
The computer answers come from top \abr{ai} models, while the human
answers come from students in the class.
...
einer Lehrveranstaltung auf Deutsch ver\"offentlicht: \href{https://www.youtube.com/watch?v=Nc_uzuDrROk}{https://www.youtube.com/watch?v=Nc_uzuDrROk}.
...
%
My last star undergraduate student, Chenglei Si (class of 2024)
went to Stanford with six publications in top venues.
