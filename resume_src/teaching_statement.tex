...
%
We then score how adversarial the questions are using item response theory~\cite{Sung:Gor:Fleisig:Mondal:Boyd-Graber-2025}.
%
...
Bisher hatte ich noch keine Gelegenheit, auf Deutsch zu
...
Ich bringe Geduld und Verst\"andnis mit und weiss\footnote{Da wir uns hier speziell mit Sprachkompetenz besch\"aftigen, wollte ich kurz erkl\"aren, warum ich das Eszett nicht verwende: Wir haben eine Zeit lang in der Schweiz gelebt und verwenden \"ublicherweise die dortigen Rechtschreibkonventionen (wir verwenden im Alltag auch W\"orter wie ``Velo'' und ``Trottior'').} aus eigener Erfahrung,
...
einer Lehrveranstaltung auf Deutsch ver\"offentlicht: \href{https://www.youtube.com/watch?v=Nc_uzuDrROk}{https://www.youtube.com/watch?v=Nc\_uzuDrROk}.
