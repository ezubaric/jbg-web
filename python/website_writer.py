...
kSTUDENTS = {"Tasnim Kabir": Student("Tasnim Kabir", 2024, 2027),
             ...
             "Wichayaporn Wongkamjan": Student("Wichayaporn Wongkamjan", 2022, 2026,"https://wwongkamjan.github.io"),
             "Ke Zhai": Student("Ke Zhai", 2010, 2014, "https://kzhai.github.io/",
                                job="Apple"),
             "Weiwei Yang": Student("Weiwei Yang", 2014, 2019, "https://ywwbill.github.io/"),
             "Yoo Yeon Sung": Student("Yoo Yeon Sung", 2019, 2025, "http://yysung.github.io/", job="Hippocratic AI"),
             ...
             "Forough Poursabzi-Sangdeh": Student("Forough Poursabzi-Sangdeh", 2014, 2018, "https://www.microsoft.com/en-us/research/people/fpoursabzi/projects/", job="Microsoft"),
             ...
             "He He": Student("He He", 2012, 2016, "https://hhexiy.github.io/",
                              job="NYU, Faculty"),
             "Shudong Hao": Student("Shudong Hao", 2015, 2017, "https://www.stevens.edu/profile/shao14", job="Stevens Institute of Technology, Teaching Assistant Professor and Associate Chair for Graduate Studies"),
             "Mozhi Zhang": Student("Mozhi Zhang", 2016, 2021, "http://www.mozhi.umiacs.io"),
             "Jo Shoemaker": Student("Jo Shoemaker", 2017, 2020),
             "Michelle Yuan": Student("Michelle Yuan", 2017, 2022, "https://forest-snow.github.io/", job="Oracle",
             ...
             "Viet-An Nguyen": Student("Viet-An Nguyen", 2011, 2015,
                                       "https://viet-an.github.io/",
                                       job="Facebook"),
             "Pedro Rodriguez": Student("Pedro Rodriguez", 2015, 2021, "https://www.pedro.ai/", job="Meta", thesis_url="https://www.pedro.ai/static/publications/pedro_rodriguez_phd_thesis.pdf", thesis="Evaluating Machine Intelligence with Question Answering"),
             "Fenfei Guo": Student("Fenfei Guo", 2015, 2027, "https://www.linkedin.com/in/fenfei-guo-74924031"),
             "You Lu": Student("You Lu", 2016, 2017, kind="MS", job="Shenzhen University of Advanced Technology, Faculty"),
             "Mohamad Alkhouja": Student("Mohamad (Jude) Alkhouja", 2011, 2013, kind="MS"),
             "Wenyan Li": Student("Wenyan Li", 2017, 2018, kind="MS"),
             "Thang Nguyen": Student("Thang Nguyen", 2014, 2019, "https://www.linkedin.com/in/thang-nguyen-a4a04922", job="CGI Federal, Data Scientist"),
             "Mohit Iyyer": Student("Mohit Iyyer", 2014, 2017, "https://people.cs.umass.edu/~miyyer/", job="UMD, Faculty"),
             "Manjhunath Ravi": Student("Manjhunath Ravi", 2015, 2016, kind="MS"),
             "Alvin {Grissom II}": Student("Alvin Grissom II", 2013, 2017, "https://agrissom.sites.haverford.edu/",
                                           job="Haverford College, Faculty"),
             "Eric Wallace": Student("Eric Wallace", 2018, 2019, "http://www.ericswallace.com/", kind="UG", job="OpenAI"),
             ...
             "Ahmed Elgohary": Student("Ahmed Elgohary Ghoneim", 2018, 2021, "https://aagohary.github.io/"),
